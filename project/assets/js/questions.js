...
$(document).ready((function () {
    if ($(".questions-menu, .questions-nav-menu").length) {
        ...
        "" == (s = (s = (s = s.substring(0, -1 == s.indexOf("#") ? s.length : s.indexOf("#"))).substring(0, -1 == s.indexOf("?") ? s.length : s.indexOf("?"))).substr(s.lastIndexOf("/") + 1)) && (s = "index.html"), $(".questions-menu li a").each((function () {

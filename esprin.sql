...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 07 avr. 2022 à 00:02
...
INSERT INTO `annoncement` (`idAnn`, `subject`, `content`, `destination`, `createdAt`, `catAnn`, `idSender`, `state`) VALUES
(5, 'weekly checkout', 'this is a simple weekly checkout', 'Etudiants', '2022-02-27 23:21:46', 0, 10020855, 'Active'),
(6, 'schedule for this week', 'dear Students, this is the schedule for this week', 'Etudiants', '2022-02-27 23:21:46', 0, 10020855, 'Active'),
(7, 'weekly checkout', 'this is a simple weekly checkout', 'Etudiants', '2022-02-27 23:21:46', 0, 10020855, 'Active'),
(8, 'schedule for this week', 'dear Students, this is the schedule for this week', 'Etudiants', '2022-02-27 23:21:46', 0, 10020855, 'Active'),
(9, 'weekly checkout', 'this is a simple weekly checkout', 'Etudiants', '2022-02-27 23:21:46', 0, 10020855, 'Deleted'),
(10, 'Request Room A12', 'we inform you that room A12 is available Wednesday after noon', 'Clubs', '2022-02-27 23:21:46', 0, 10020855, 'Active');

-- --------------------------------------------------------

--
-- Structure de la table `catalert`
--

CREATE TABLE `catalert` (
  `idCatAlert` int(11) NOT NULL,
  `libCatAlert` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Structure de la table `catannonce`
--

CREATE TABLE `catannonce` (
  `idCatAnn` int(11) NOT NULL,
  `libCatAnn` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(10020855, 'bairem.khedhri@esprit.tn', 'bairem1111', '2022-02-11 20:11:24', '264822482_959189045008835_8249503408997441961_n.jpg', 'bairem', 'khedhri', NULL, 'Financier', NULL, NULL, NULL, NULL, 'Admin', 'Connected'),
...
(25453121, 'firas.belhadjamor@esprit.tn', 'welcomefiras11', '2022-03-08 15:33:54', 'medali.jpg', 'Firas', 'BelhadjAmor', NULL, 'Stage', NULL, NULL, NULL, NULL, 'Admin', 'Deleted'),
(85452241, 'mohamed.hosni@esprit.tn', 'test123', '2022-03-10 10:17:17', 'medali.jpg', 'mohamed', 'hosni', NULL, 'Examen', NULL, NULL, NULL, NULL, 'Admin', 'Active'),
...
--
-- Index pour la table `catalert`
--
ALTER TABLE `catalert`
  ADD PRIMARY KEY (`idCatAlert`);

--
-- Index pour la table `catannonce`
--
ALTER TABLE `catannonce`
  ADD PRIMARY KEY (`idCatAnn`);
...
--
-- AUTO_INCREMENT pour la table `catalert`
--
ALTER TABLE `catalert`
  MODIFY `idCatAlert` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `catannonce`
--
ALTER TABLE `catannonce`
  MODIFY `idCatAnn` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `alert`
  ADD CONSTRAINT `FK cat alert` FOREIGN KEY (`catAlert`) REFERENCES `catalert` (`idCatAlert`),

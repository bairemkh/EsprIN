...
function initEmojiPicker() {
    ...
    $(".post-comment.has-emojis").each((function () {
        t += 1;
        var o = $(this), i = o.find(".card-footer"), e = o.find("textarea"), s = o.find(".is-emoji");
...
function initLightboxEmojis() {
    ...
    $(".has-lightbox-emojis").each((function () {
        t += 1;
        var o = $(this), i = o.find(".controls-inner"), e = o.find("textarea"), s = o.find(".emoji-button");
...
function initTooltips() {
    $(".has-tooltip").ggtooltip({html: !0, textcolor: "#fff", backcolor: "#444", bordercolor: "#444"})
}
...
function initComboBox() {
    $(".is-combo .combo-box").on("click", (function () {
        ...
        var o = t.target, i = $(this).find(".item-icon i").attr("class"), e = $(this).find(".item-icon i"),
...
function initImageComboBox() {
    $(".is-combo .image-combo-box").on("click", (function () {
        ...
        var o = t.target, i = $(this).find(".item-icon img").attr("src"), e = $(this).find(".item-name").text();
...
function initUserComboBox() {
    $(".is-combo .user-combo-box").on("click", (function () {
        ...
        var o = t.target, i = $(this).find(".item-icon .avatar").attr("src"),
            e = $(this).find(".item-icon .badge").attr("src"), s = $(this).find(".item-name").text();
